...
### บันทึกความคืบหน้า — ช่องเดียวที่ AI เขียนข้อความลงระบบได้

`add_note` เขียนต่อท้ายหน้าแบบ append-only แก้หรือลบไม่ได้ (บันทึกที่แก้ย้อนหลังได้
ไม่ใช่บันทึก — เขียนผิดให้เขียนใหม่ต่อท้าย)

มีอยู่เพราะเนื้อหาของหน้าเป็น CRDT ที่เซิร์ฟเวอร์เขียนไม่ได้อย่างปลอดภัย ช่องนี้จึงให้
AI รายงานความคืบหน้า ตั้งคำถาม หรือสรุปสิ่งที่ทำไปได้ **ด้วยความเสี่ยงต่อข้อมูลเป็นศูนย์**
และเจ้าของอ่านแยกจากเอกสารของตัวเองได้ชัดเจน
...
> ระหว่างที่ยังเขียนเนื้อหาไม่ได้ ช่องเขียนข้อความคือ `add_note` ซึ่งครอบความต้องการ
> ส่วนใหญ่ ("รายงานสิ่งที่ทำไป", "ตั้งคำถามถึงเจ้าของ") ที่ความเสี่ยงเป็นศูนย์
...
node scripts/verify-mcp.mjs       # 43 เคส
```
...
- **จำนวน tool ไม่บานปลาย** — มีเคสยืนยันว่ามี 7 ตัวเป๊ะและไม่มี `purge`
