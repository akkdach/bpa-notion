...
public static class TaskTools
{
    ...
    [Description("ต่อท้ายเนื้อหาเข้าไปใน \"เนื้อหาของหน้า\" จริง ๆ (ต่างจาก add_note ที่เขียน " +
                 ...
                 "ตาราง GFM (| คั่น |) → ตารางจริง, รูป ![ชื่อ](url) → บล็อกรูปจาก URL. " +
                 "HTML ดิบยังถูกลดรูปแล้วรายงานกลับ. ต่อท้ายอย่างเดียว — " +
    ...
    [Description("เขียนทับ \"เนื้อหาของหน้า\" ทั้งหน้าด้วย markdown ชุดใหม่ — ของเดิมถูกแทนที่" +
                 ...
                 "append_content (```mermaid → แผนภาพ, ตาราง GFM → ตารางจริง, รูปจาก URL → บล็อกรูป, " +
                 "HTML ดิบถูกลดรูปแล้วรายงานกลับ). " +
