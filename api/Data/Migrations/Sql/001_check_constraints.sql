...
--
--  ⚠️ ไฟล์นี้ถูกรันโดย migration AddSqlObjects ซึ่ง "ลงไปแล้ว" — ห้ามแก้เพิ่ม
--     หรือแก้ constraint ที่นี่ เพราะฐานที่ลง migration ไปแล้วจะไม่ได้รับ ส่วนฐาน
--     ที่สร้างใหม่จะได้ → constraint มีอยู่บนบางฐานเท่านั้นแบบเงียบ ๆ
--     ของใหม่/ของที่แก้ ไปอยู่ในไฟล์ที่มีเลขสูงกว่าพร้อม migration ของตัวเอง
--     (ดูตัวอย่างการ DROP แล้ว ADD ใหม่ใน 004_page_links_and_acl_subject.sql)
--     รายการใน "ไฟล์นี้" จึงไม่ใช่สถานะปัจจุบันของฐาน — ต้องอ่าน 00x ถัดไปด้วย
-- ═══════════════════════════════════════════════════════════════════════════
